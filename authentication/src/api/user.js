...
import { ADMIN_ENUM, ADMIN_SIGNUP_URL, BAD_REQUEST_CODE_400, DUB_EMAIL_ERROR_MESSAGE, DUB_USERNAME_ERROR_MESSAGE, DUPLICATE_KEY_ERROR_CODE, OK_REQUEST_CODE_200, ONE_DAY_MAX_AGE_IN_MIINUTS, ONE_DAY_MAX_AGE_IN_MILLEMIINUTS, PATIENT_ENUM, PATIENT_SIGNUP_URL, PHARMACIST_ENUM, PHARMACIST_SIGNUP_URL } from "../utils/Constants.js";
    ...
    app.post('/signup', async (req, res) =>{
        try{
            ...
            switch(type){
                ...
                case ADMIN_ENUM:case PHARMACIST_ENUM: email = req.body.userData.email; userName = req.body.userData.userName;break;
